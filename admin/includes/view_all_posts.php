...
// check the comments table the comment id related to that specific post id and count the number of rows in that tables the  display the number
$query = "SELECT * FROM comments WHERE comment_post_id = $post_id";
$send_comment_query = mysqli_query($connection,$query);

$row = mysqli_fetch_array($send_comment_query);
//below code was supposed to be useful but it woks without it so i dont realy know what happens
